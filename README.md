...
Lagan core files
================
Contains the Lagan base model for all Lagan models. Each type of content has it's own model that extends this model.
Also contains the Lagan search controller.
